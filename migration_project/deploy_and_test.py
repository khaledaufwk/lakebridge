#!/usr/bin/env python3
"""Deploy updated loader and test credentials."""
import sys
import base64
import time
...
def main():
    ...
    notebook_local = Path(__file__).parent / "pipelines/timescaledb/notebooks/test_jdbc.py"
    notebook_path = "/Workspace/migration_project/pipelines/timescaledb/notebooks/test_jdbc"

    print("\nDeploying test notebook...")
